...
class SettingController extends Controller
{
    ...
    public function update(Request $request)
    {
        $data = $request->validate([
            ...
            'logo' => ['nullable', 'image', 'mimes:jpg,jpeg,png,webp', 'max:2048'], 'favicon' => ['nullable', 'image', 'mimes:png,jpg,jpeg,webp', 'max:512'], 'principal_photo' => ['nullable', 'image', 'mimes:jpg,jpeg,png,webp', 'max:3072'],
        ]);
