...
class AlumniController extends Controller {
    public function index() { return view('public.alumni.index', ['alumni' => Alumni::public()->orderBy('order')->latest('graduation_year')->paginate(12)]); }
    public function create() { return view('public.alumni.register'); }
