                        ...
                        <article class="interactive-card group flex flex-col justify-between p-6 sm:p-7">
                            <div class="space-y-4">
                                <div class="flex items-center gap-3">
                                    <div class="flex size-12 shrink-0 items-center justify-center rounded-2xl bg-primary-100 text-primary-800 font-bold overflow-hidden shadow-soft">
                                        @if($person->photo)
                                    ...
                                    <div class="min-w-0">
                                        <h2 class="text-base font-bold tracking-tight text-slate-950 group-hover:text-primary-800 transition truncate">
                                            {{ $person->name }}
                                        </h2>
