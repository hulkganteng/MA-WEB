<x-layouts.app title="Program Pendidikan & Peminatan" description="Pilihan peminatan MIPA, IPS, dan Keagamaan MA Ma'arif NU Assa'adah Bungah Gresik.">
    ...
    <section class="bg-slate-50/60 py-14 sm:py-20">
        <div class="container-app space-y-12">
            ...
            <div class="rounded-3xl border border-gold-400/30 bg-gradient-to-r from-primary-950 via-primary-900 to-slate-950 p-6 sm:p-8 text-white shadow-lift flex flex-col sm:flex-row items-center justify-between gap-6">
                <div class="space-y-2">
                    ...
                    <p class="text-xs text-primary-200 leading-relaxed max-w-xl">
                        Ikuti simulasi tes minat dan bakat singkat kami untuk mendapatkan rekomendasi jurusan yang paling sesuai dengan potensi dan cita-citamu.
                    </p>
                </div>
                <button type="button" @click="$store.spmbCalc.open()"
                        class="btn-gold !bg-gold-500 hover:!bg-gold-400 text-gold-950 font-bold shrink-0 shadow-glow-gold">
                    <x-icon name="compass" class="size-4" /> Mulai Simulasi Sekarang
                </button>
            </div>
                        ...
                        <article class="interactive-card group flex flex-col justify-between p-6 sm:p-8">
                            <div>
                                <div class="flex items-center justify-between gap-2">
                                    ...
                                    <span class="flex size-9 items-center justify-center rounded-xl bg-slate-100 text-slate-700 group-hover:bg-primary-600 group-hover:text-white transition">
                                        <x-icon name="graduation-cap" class="size-5" />
                                    </span>
                                </div>

                                <h2 class="mt-4 text-xl font-bold tracking-tight text-slate-950 group-hover:text-primary-800 transition">
