<x-layouts.app title="Kurikulum & Dokumen Akademik" description="Struktur Kurikulum Merdeka terintegrasi Pesantren MA Ma'arif NU Assa'adah Bungah Gresik.">
    ...
    <section class="bg-slate-50/60 py-14 sm:py-20">
        <div class="container-app max-w-5xl space-y-8">
            ...
            <div class="rounded-3xl border border-primary-500/20 bg-primary-950 p-6 sm:p-8 text-white shadow-lift">
                <div class="flex flex-col sm:flex-row items-center justify-between gap-6">
                    <div class="space-y-2">
                        <span class="rounded-full bg-gold-400/20 px-3 py-1 text-xs font-bold text-gold-300 ring-1 ring-gold-400/30">
                    ...
                    <div class="flex items-center gap-2 shrink-0">
                        <span class="rounded-2xl border border-white/10 bg-white/5 p-4 text-center">
                            <span class="block font-mono text-2xl font-bold text-gold-300">54</span>
                            <span class="text-[10px] text-primary-200 uppercase">JP per Pekan</span>
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-4">
                @forelse($curriculums as $curriculum)
                    <article class="interactive-card flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 p-6 sm:p-8">
                        ...
                        @if($curriculum->document)
                            <a href="{{ asset('storage/'.$curriculum->document) }}" download
                               class="btn-gold !bg-gold-500 hover:!bg-gold-400 font-bold shrink-0 shadow-soft">
