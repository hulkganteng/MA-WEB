        ...
        <div class="container-app grid items-start gap-12 lg:grid-cols-12">
            ...
            <div class="lg:col-span-4 space-y-6">
                <div class="overflow-hidden rounded-3xl border border-slate-200/80 bg-white p-6 shadow-soft text-center">
                    <div class="relative mx-auto aspect-[4/5] w-full max-w-[280px] overflow-hidden rounded-2xl border border-slate-100 bg-primary-950">
                    ...
                    <h3 class="mt-5 text-lg font-bold text-slate-950">{{ setting('principal.name', 'Mohammad Isma\'il Cholilur Rohman, M.Pd.') }}</h3>
                    <p class="text-xs font-semibold text-primary-700">{{ setting('principal.position', 'Kepala MA Ma\'arif NU Assa\'adah') }}</p>
                    ...
                    <div class="mt-5 pt-5 border-t border-slate-100 space-y-2 text-left text-xs text-slate-600">
                        <div class="flex items-center gap-2">
                            <x-icon name="shield-check" class="size-4 text-emerald-600 shrink-0" />
                ...
                <div class="rounded-3xl border border-primary-500/20 bg-primary-950 p-6 text-white text-xs space-y-3">
            ...
            <article class="lg:col-span-8">
                <div class="rounded-3xl border border-slate-200/80 bg-white p-6 sm:p-12 shadow-soft">
                    <div class="text-center pb-8 border-b border-slate-100">
                        <p class="font-arabic text-2xl sm:text-3xl text-primary-900 font-bold" dir="rtl">
                            بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ
                        </p>
                        <p class="mt-2 text-xs font-bold uppercase tracking-widest text-gold-700">
